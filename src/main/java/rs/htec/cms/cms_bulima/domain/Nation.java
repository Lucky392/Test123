...
@NamedQueries({
    ...
    @NamedQuery(name = "Nation.findByCreateDate", query = "SELECT n FROM Nation n WHERE n.createDate = :createDate")})
public class Nation implements Serializable {
    ...
    public Nation(Long id, Date createDate) {
        this.id = id;
