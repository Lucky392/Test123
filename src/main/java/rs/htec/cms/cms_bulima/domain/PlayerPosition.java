...
@NamedQueries({
    ...
    @NamedQuery(name = "PlayerPosition.findByName", query = "SELECT p FROM PlayerPosition p WHERE p.name = :name"),
    @NamedQuery(name = "PlayerPosition.findByCreateDate", query = "SELECT p FROM PlayerPosition p WHERE p.createDate = :createDate")})
public class PlayerPosition implements Serializable {
    ...
    @OneToMany(mappedBy = "idPlayerPosition")
    private List<Player> playerList;

    public PlayerPosition() {
    }

    public PlayerPosition(Long id) {
        this.id = id;
    }

    public PlayerPosition(Long id, Date createDate) {
        this.id = id;
