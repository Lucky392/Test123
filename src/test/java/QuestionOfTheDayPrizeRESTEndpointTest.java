...
public class QuestionOfTheDayPrizeRESTEndpointTest {
    ...
    //
     ...
     public void testGetPrizeSuccess(){
         ...
         assertEquals(r.getEntity().getClass(), new ArrayList<QuestionOfTheDayPrize>().getClass());
         assertEquals(((List)r.getEntity()).size(), 1);
         assertEquals(((List)r.getEntity()).get(0).getClass(), QuestionOfTheDayPrize.class);
     }
